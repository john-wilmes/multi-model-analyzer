export { cloneOrFetch, isBareRepo, getHeadCommit, fetchLocalRepo, getTrackedCommit, diffFiles, getFileContent, getFileContentBatch, parseNameStatus, parseRevisionRange, getChangedFilesInRange, getCommitHistory } from "./git.js";
export type { GitOptions, RevisionRange, CommitFileChange } from "./git.js";

export { detectChanges, classifyFile, classifyFiles, isExcludedPath } from "./changeset.js";
