...
import type { MethodPurpose, MethodPurposeMap, SymbolInfo, HeuristicResult } from "@mma/core";
...
export function analyzeNamingWithMeta(
  files: ReadonlyMap<string, readonly SymbolInfo[]>,
  repo: string,
): HeuristicResult<MethodPurposeMap> {
  return runHeuristic(repo, "analyzeNaming", () => analyzeNaming(files, repo), (d) => d.methods);
}
